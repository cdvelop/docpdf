...
package raster // import "github.com/cdvelop/docpdf/freetype/raster"
...
func (r *Rasterizer) Add2(b, c docpdf.Point26_6) {
	...
	for i >= 0 {
		...
		if s > 0 {
			...
			r.Add1(docpdf.Point26_6{midx, midy})
			r.Add1(p[0])
			i--
		}
	}
