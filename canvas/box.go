...
func (b Box) Width() int {
	return mathutils.AbsInt(b.Right - b.Left)
}

// Height returns the height
func (b Box) Height() int {
	return mathutils.AbsInt(b.Bottom - b.Top)
}
...
func (b Box) Grow(other Box) Box {
	return Box{
		Top:    mathutils.MinInt(b.Top, other.Top),
		Left:   mathutils.MinInt(b.Left, other.Left),
		Right:  mathutils.MaxInt(b.Right, other.Right),
		Bottom: mathutils.MaxInt(b.Bottom, other.Bottom),
	}
}
...
func (b Box) Constrain(other Box) Box {
	...
	newBox.Top = mathutils.MaxInt(newBox.Top, other.Top)
	newBox.Left = mathutils.MaxInt(newBox.Left, other.Left)
	newBox.Right = mathutils.MinInt(newBox.Right, other.Right)
	newBox.Bottom = mathutils.MinInt(newBox.Bottom, other.Bottom)
